...
class BlogController extends Controller
{
    public function index()
    {
        try {
            //$blog = Post::all();
			$blog = DB::select('SELECT a.id as id, a.title as title, a.content as content, a.status as status, b.name as id_member FROM posts a, users b WHERE a.id_member = b.id');
