            ...
            <div class="px-6 pt-10 flex justify-between">
                <div class="flex items-center cursor-pointer" @click="router.push({name: 'Dashboard'})">
                    ...
                    <span class="ml-2 font-bold"
                        >Laravel 8, Vue.js 3, Tailwind CSS v3.0 SPA CRUD using MySQL</span
                    >
                </div>

                <div class="flex items-center space-x-4">
                    <a href="https://github.com/teguharifudin/Cognotiv" target="_blank"><i class="fab fa-github fa-2x"></i></a>
                </div>
            </div>
